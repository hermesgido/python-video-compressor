...
def compress_video(input_file, output_file, target_size, remove_sound= False):
    try:
        probe = ffmpeg.probe(input_file)
        duration = float(probe['format']['duration'])
...
input_video = '/home/hermes/now2.mkv'
output_video = '/home/hermes/HermesGido-APIManager4Developer.mp4'
target_size_mb = 100

compress_video(input_video, output_video, target_size_mb, remove_sound=True)
